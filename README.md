...
### 1. Extração (Extract)
* **Fonte:** API OpenWeatherMap (consultando `q=Sao Paulo,BR` com parâmetros de unidade no sistema métrico, garantindo que a temperatura já venha em graus Celsius).
